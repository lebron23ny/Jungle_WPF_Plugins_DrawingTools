...
{
    public class DrawRightYLabel : IDrawLabel
    {
        public void DrawLabel(Point pickedPoint, TSD.View viewBase,
            double frameHeight, double frameWidth, string nextLabel,
            string prevLabel, TSD.Grid grid, enumPositionDraw positionDraw, TSD.FrameTypes frameType)
        {

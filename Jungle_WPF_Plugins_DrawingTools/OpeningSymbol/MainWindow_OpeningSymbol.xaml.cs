...
{
    /// <summary>
    /// Логика взаимодействия для MainWindow_OpeningSymbol.xaml
    /// </summary>
    public partial class MainWindow_OpeningSymbol : TSDI.PluginWindowBase
    {
        public MainWindowViewModelOS dataViewModel { get; set; }
        public MainWindow_OpeningSymbol(MainWindowViewModelOS viewModel)
        {
            InitializeComponent();
